...
/**
 * Resize an image using object-fit cover and contain modes, with proportional scaling support.
 ...
 * * `width` - New width. If 0, it's calculated from height.
 * * `height` - New height. If 0, it's calculated from width.
