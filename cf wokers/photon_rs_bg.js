...
export class PhotonImage {
    ...
    /**
     * Convert the PhotonImage to raw bytes in PNG format, for use in Node.js.
     * @returns {Uint8Array}
     */
    toPngBytes() {
        const ret = wasm.photonimage_toPngBytes(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
...
/**
 * Resize an image using object-fit cover and contain modes.
 * A new PhotonImage is returned.
 *
 * # Arguments
 * * `photon_img` - A PhotonImage.
 * * `width` - New width.
 * * `height` - New height.
 * * `sampling_filter` - The sampling filter to use.
 * * `scaling_mode` - The scaling mode to use, `Cover` or `Contain`.
 *
 * # Example
 *
 * ```no_run
 * use photon_rs::native::open_image;
 * use photon_rs::transform::{resize_object_fit, SamplingFilter, ScalingMode};
 *
 * let img = open_image("img.jpg").expect("File should open");
 * // To Cover
 * let cover_img = resize_object_fit(&img, 500, 500, SamplingFilter::Nearest, ScalingMode::Cover);
 * // To Contain
 * let contain_img = resize_object_fit(&img, 500, 500, SamplingFilter::Nearest, ScalingMode::Contain);
 * ```
 * @param {PhotonImage} photon_img
 * @param {number} width
 * @param {number} height
 * @param {SamplingFilter} sampling_filter
 * @param {ScalingMode} scaling_mode
 * @returns {PhotonImage}
 */
export function resize_object_fit(photon_img, width, height, sampling_filter, scaling_mode) {
    _assertClass(photon_img, PhotonImage);
    const ret = wasm.resize_object_fit(photon_img.__wbg_ptr, width, height, sampling_filter, scaling_mode);
    return PhotonImage.__wrap(ret);
}
...
export function __wbg_drawImage_00302fc1908197cc() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
    arg0.drawImage(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
}, arguments); }
export function __wbg_drawImage_51b6a9d03c34c5cc() { return handleError(function (arg0, arg1, arg2, arg3) {
...
export function __wbg_height_408f385de046f7e5(arg0) {
    const ret = arg0.height;
    return ret;
}
export function __wbg_height_87250db2be5164b9(arg0) {
    const ret = arg0.height;
    return ret;
}
...
export function __wbg_set_textContent_3e87dba095d9cdbc(arg0, arg1, arg2) {
...
export function __wbg_width_5901d980713eb80b(arg0) {
...
export function __wbg_width_be8f36d66d37751f(arg0) {
    const ret = arg0.width;
    return ret;
}
