 ...
 * ```
 */
export function resize_object_fit(photon_img: PhotonImage, width: number, height: number, sampling_filter: SamplingFilter, scaling_mode: ScalingMode): PhotonImage;
...
export interface InitOutput {
    ...
    readonly photonimage_toPngBytes: (a: number) => [number, number];
    ...
    readonly resize_object_fit: (a: number, b: number, c: number, d: number, e: number) => number;
